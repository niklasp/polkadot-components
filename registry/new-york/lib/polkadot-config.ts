...
// Import available descriptors - these are generated by `npx papi`
...
// To add more chains:
// 1. Run `npx papi add <chain-name> -n <chain-name>` to add the chain
// 2. Import the descriptor from "@polkadot-api/descriptors" above
// 3. Add the chain configuration below
